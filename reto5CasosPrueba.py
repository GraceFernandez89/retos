...
#Casos publicos                
print(casos_positivos('https://raw.githubusercontent.com/PaulaAndresOli/P23/main/casos_positivos_colombia.csv'))
print(casos_positivos('https://raw.githubusercontent.com/PaulaAndresOli/P23/main/casos_positivos_colombia.txt'))
